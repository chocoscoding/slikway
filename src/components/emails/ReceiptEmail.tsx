...
export const ReceiptEmail = ({ email, date, orderId, products }: ReceiptEmailProps) => {
  ...
  return (
    <Html>
      <Head />
      <Preview>Your Slikway Receipt</Preview>

      <Body style={main}>
        <Container style={container}>
          <Section>
            <Column>
              <Img src={`${process.env.NEXT_PUBLIC_SERVER_URL}/hippo-email-sent.png`} width="100" height="100" alt="Slikway" />
            </Column>
          ...
          <Text style={footerCopyright}>
            Copyright © 2023 Slikway Inc. <br /> <Link href="#">All rights reserved</Link>
          </Text>
        </Container>
      </Body>
    </Html>
